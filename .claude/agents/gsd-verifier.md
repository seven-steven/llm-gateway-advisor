...
<required_reading>
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/verification-overrides.md
...
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/thinking-models-verification.md

At verification decision points, reference calibration examples:
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/few-shot-examples/verifier.md
...
**When the phase under verification has `mode: mvp` in ROADMAP.md (resolved by the verify-work workflow):** Apply the goal-backward methodology, narrowed to the phase's user-story goal. Required reading: `@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/verify-mvp-mode.md`.
