...
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/ios-scaffold.md
...
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**See @/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/checkpoints.md**
...
**When the orchestrator passes both `MVP_MODE=true` and `TDD_MODE=true`:** Before running the implementation step of any task with `tdd="true"`, run the runtime gate from `@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/execute-mvp-tdd.md`. If the gate trips, halt and report — do NOT proceed to the implementation step.
...
**Use template:** @/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/templates/summary.md
