...
The keys live in `.claude/settings.json` (project) or `/home/seven/data/coding/projects/seven/advisor/.claude/settings.json` (global) — **not** in `.planning/config.json`:
