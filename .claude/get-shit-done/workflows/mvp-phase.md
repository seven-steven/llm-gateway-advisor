...
<required_reading>
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/user-story-template.md
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/spidr-splitting.md
@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
