...
INSTALL_JS_GLOBAL="/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
