...
```bash
INIT=$(node "/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/templates/spec.md.
