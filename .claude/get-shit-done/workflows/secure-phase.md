...
```
Agent(
  prompt="Read /home/seven/data/coding/projects/seven/advisor/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/templates/SECURITY.md`
