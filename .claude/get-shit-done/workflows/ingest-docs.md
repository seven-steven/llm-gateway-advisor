...
```bash
INIT=$(node "/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
