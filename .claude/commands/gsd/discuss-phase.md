...
Read and execute `/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/workflows/list-phase-assumptions.md` end-to-end.
Stop here.

Otherwise, if `DISCUSS_MODE` is `"assumptions"`:
Read and execute `/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/workflows/discuss-phase-assumptions.md` end-to-end.

Otherwise (`"discuss"` / unset / any other value):
Read and execute `/home/seven/data/coding/projects/seven/advisor/.claude/get-shit-done/workflows/discuss-phase.md` end-to-end.
